...
class CartController extends AbstractController
{
     ...
     *
     * @Route("/cart/up/{productClassId}", name="cart_up", requirements={"productClassId": "\d+"})
     */
    public function handleCartItem_up( $productClassId)
    {
    	$operation='up';
    	log_info('カート明細操作開始', ['operation' => $operation, 'product_class_id' => $productClassId]);
     ...
     * カートをロック状態に設定し、購入確認画面へ遷移する.
     *
     * @Route("/cart/down/{productClassId}", name="cart_down", requirements={"productClassId": "\d+"})
     */
    public function handleCartItem_down( $productClassId)
    {
    	$operation='down';
    	log_info('カート明細操作開始', ['operation' => $operation, 'product_class_id' => $productClassId]);
     ...
     * カートをロック状態に設定し、購入確認画面へ遷移する.
     *
     * @Route("/cart/remove/{productClassId}", name="cart_remove", requirements={"productClassId": "\d+"})
     */
    public function handleCartItem_remove( $productClassId)
    {
    	$operation='remove';
    	log_info('カート明細操作開始', ['operation' => $operation, 'product_class_id' => $productClassId]);
